    ...
    public class UpdateRideCommandValidator : AbstractValidator<UpdateRideCommand>
    {
        public UpdateRideCommandValidator()
        {
            ...
            RuleFor(r => r.DeparturePlaceId)
                .GreaterThan(0).WithMessage("DeparturePlaceId не може бути меншим або рівни 0.");

            RuleFor(r => r.ArrivalPlaceId)
                .GreaterThan(0).WithMessage("ArrivalPlaceId не може бути меншим або рівни 0.");

            RuleFor(r => r)
                .Must(ArrivalTimeGreaterThanDepartureTime).WithMessage("Дата відправки не може бути більшою або рівною даті прибуття.");
        }
        private bool ArrivalTimeGreaterThanDepartureTime(UpdateRideCommand ride)
        {
